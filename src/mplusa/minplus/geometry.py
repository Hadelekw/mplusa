...
class AbstractPolytope:
    ...
    def get_apices(self) -> np.ndarray:
        """ Returns an array of apices corresponding to the half-spaces generated by the facet-defining hyperplanes. """
        return self.pseudovertices  # TODO: verify correctness of this statement.
